...
* update to latest [@next](https://github.com/next) client ([d332773](https://github.com/sinnerschrader/patternplate/commit/d332773))


### Features

* enable static build for docs ([f2ed7ff](https://github.com/sinnerschrader/patternplate/commit/f2ed7ff))
