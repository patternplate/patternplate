...
const _duration = require('duration');

const _duration2 = _interopRequireDefault(_duration);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function formatDuration(start) {
  const end = arguments.length <= 1 || arguments[1] === undefined ? new Date() : arguments[1];
