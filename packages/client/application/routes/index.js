...
const _renderPage = require('../../library/render-page');

const _renderPage2 = _interopRequireDefault(_renderPage);
...
function indexRouteFactory(application) {
  return function indexRoute() {
    return new Promise(function ($return, $error) {
      ...
      return (0, _renderPage2.default)(application, this.request.url).then(function ($await_1) {
        this.body = $await_1;
        return $return();
