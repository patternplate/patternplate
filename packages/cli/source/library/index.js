...
async function patternplate(args) {
  ...
  const patternplateOptions = merge(
    {},
    topLevel,
    options.patternplate,
    patternplateSpecifics
  );
  ...
  const patternplateServerOptions = merge(
    {},
    topLevel,
    options.patternplateServer,
    topLevel,
    patternplateSeverSpecifics
  );
  const patternplateServerInstance = await patternplateServer(
    patternplateServerOptions
  );
  ...
  const patternplateClientOptions = merge(
    ...
    options.patternplateServer,
    topLevel,
    patternplateClientSpecifics
  );
  const patternplateClientInstance = await patternplateClient(
    patternplateClientOptions
  );

  patternplate.log.debug(
  ...
  if (patternplateServerInstance.runtime.mode === "server") {
    ...
    patternplateClientInstance.log.debug(
      `Changing patternplate-client.client.path to ${patternplateServerInstance
        .runtime.prefix}`
    );
  } else {
  ...
  const resources = [
    ...
    ...(patternplate.server.resources || []),
    ...(patternplate.client.resources || [])
  ];
